...
private boolean isSubdiretorioImediato(String diretorioPai, String candidato) {
    ...
    // Resolve o caminho completo para origem se for relativo
    ...
    String caminhoDiretorioOrigem = (ultimaBarraOrigem == 0) ? "/" : caminhoOrigem.substring(0, ultimaBarraOrigem);
    ...
    // Resolve o caminho completo para o destino
    ...
    System.out.println("Arquivo copiado para " + caminhoCompletoDestino);
